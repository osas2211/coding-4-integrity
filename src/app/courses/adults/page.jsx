...
const AdultsCoursesPage = () => {
  ...
  const workItems = useMemo(
    () => [
      {
        index: "Chapter 01",
        name: "Political Systems and Systemic Corruption",
        href: `/coming-soon`,
        variant: "variant-1",
        images: [
          "/work/work_1_1.jpg",
      ...
      {
        index: "Chapter 02",
        name: "The UNCAC and Global Governance",
        href: `/coming-soon`,
        variant: "variant-2",
        images: [
          "/work/work_2_1.jpg",
      ...
      {
        index: "Chapter 03",
        name: "Public Sector Vulnerabilities",
        href: `/coming-soon`,
        variant: "variant-2",
        images: [
          "/work/work_3_1.jpg",
      ...
      {
        index: "Chapter 04",
        name: "Corporate Integrity and Collective Action",
        href: `/coming-soon`,
        variant: "variant-3",
        images: [
          "/work/work_4_1.jpg",
      ...
      {
        index: "Chapter 05",
        name: "Corruption, Conflict, and Security",
        href: `/coming-soon`,
        variant: "variant-1",
        images: [
          "/work/work_5_1.jpg",
...
export default AdultsCoursesPage
