...
const TeensCoursesPage = () => {
  ...
  const workItems = useMemo(
    () => [
      ...
      {
        index: "Chapter 02",
        name: "Corruption in the School System",
        href: `/coming-soon`,
        variant: "variant-2",
        images: [
          "/work/work_2_1.jpg",
      ...
      {
        index: "Chapter 03",
        name: "Corruption and Human Rights Violations",
        href: `/coming-soon`,
        variant: "variant-2",
        images: [
          "/work/work_3_1.jpg",
      ...
      {
        index: "Chapter 04",
        name: "Gender and Vulnerability to Corruption",
        href: `/coming-soon`,
        variant: "variant-3",
        images: [
          "/work/work_4_1.jpg",
      ...
      {
        index: "Chapter 05",
        name: "Citizenship and Accountability",
        href: `/coming-soon`,
        variant: "variant-1",
        images: [
          "/work/work_5_1.jpg",
