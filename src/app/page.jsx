          ...
          <div className="hero-content-main">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={isInitialLoad ? 5.75 : 0.75}>
                <h1>
                  Empowering the Next Generation Through Anti-Corruption
                  Awareness
                </h1>
              </Copy>
            </div>
            ...
            <div className="hero-footer-outer">
              <Copy animateOnScroll={false} delay={isInitialLoad ? 6.35 : 1.65}>
                <p className="sm">&copy; Coding 4 Integrity.</p>
                <p className="sm">( Dec, 2025 )</p>
              </Copy>
            </div>
            ...
            <div className="hero-footer">
              <Copy animateOnScroll={false} delay={isInitialLoad ? 6.05 : 1.15}>
                <p className="lg">
                  With the help of Artificial Intelligence, we're conquering
                  corruption one youth at a time.
                </p>
              </Copy>
        ...
        <div className="container">
          <div className="featured-work-header-content">
            ...
            <div className="featured-work-header-copy">
              <Copy animateOnScroll={true} delay={0.25}>
                <p className="lg">
                  From learning to active participation in stopping corruption
                  on a global scale.
                </p>
              </Copy>
            </div>
