    ...
    <section className="contact screensaver-container" ref={containerRef}>
      <div className="contact-copy">
        <div className="contact-col">
          <Copy delay={0.8}>
            <h2>To glimpse the world above corruption</h2>
          </Copy>
        </div>
        ...
        <div className="contact-col">
          ...
          <div className="contact-group">
            <Copy delay={1.2}>
              <p className="sm">Submission</p>
              <p>Hackathon of Hackathons. Doha, Qatar, 2025</p>
            </Copy>
          </div>
      ...
      <div className="contact-footer">
        <div className="container">
          <Copy delay={1.6} animateOnScroll={false}>
            <p className="sm">Coding 4 Integrity</p>
          </Copy>
          ...
          <Copy delay={2} animateOnScroll={false}>
            <p className="sm">War againts corruption</p>
          </Copy>
        </div>
      </div>
    </section>
