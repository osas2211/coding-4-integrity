...
const Footer = () => {
  ...
  useEffect(() => {
    const updateqatar = () => {
      ...
      const formatter = new Intl.DateTimeFormat("ar-QR", options)
      const qatarString = formatter.format(new Date())
      setQatar(qatarString)
    }

    updateqatar()
    const timeInterval = setInterval(updateqatar, 1000)
        ...
        <div className="footer-header-content">
          <div className="footer-header">
            <Copy animateOnScroll={true} delay={0.2}>
              <h1>Let's build a future that feels alive</h1>
            </Copy>
          </div>
